...
@Component({
  selector: 'app-declaracao-isento',
  templateUrl: './declaracao-isento.component.html',
  styleUrls: ['./declaracao-isento.component.css']
})
export class DeclaracaoIsentoComponent implements OnInit {

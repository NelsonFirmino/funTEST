...
export class ServentiaService {
  ...
  Incluir(controller: string, object: Serventia): Observable<RespostaModel> {
    return this._restfulService.SendPost<RespostaModel>(controller, object);
  }

  Alterar(controller: string, object: Serventia): Observable<RespostaModel> {
